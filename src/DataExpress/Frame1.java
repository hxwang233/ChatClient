...
public class Frame1 extends JFrame {
  ...
  private void jbInit() throws Exception  {
    ...
    database1.setConnection(new com.borland.dx.sql.dataset.ConnectionDescriptor("jdbc:mysql://localhost:3307/new_schema?useUnicode=true&characterEncoding=utf8&serverTimezone=GMT%2B8&useSSL=false\"", "Root", "123456", false, "com.mysql.cj.jdbc.Driver"));
     ...
     if (strSQL.toLowerCase().trim().startsWith("select")) {
       try {
         ...
         queryDataSet1.setQuery(new com.borland.dx.sql.dataset.QueryDescriptor(
           database1, strSQL, null,true, Load.ALL));
      ...
      try{
        ...
        JOptionPane.showMessageDialog(this, "Excuse Successfully");
      }
      catch(Exception ex2){
